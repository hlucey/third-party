...
da URL da documentação. <br><br> | Sua primeira etapa é registrar sua oferta no ambiente de trabalho do Provedor. Para obter mais informações, consulte o [Tutorial de introdução](/docs/third-party?topic=third-party-get-started#get-started). | Ambiente de trabalho do provedor |
...
a sua experiência de faturamento integrada do {{site.data.keyword.Bluemix_notm}}. Para obter mais informações, consulte [Criando sua documentação](/docs/third-party?topic=third-party-content-tasks#content-tasks). | Ambiente de trabalho do provedor |
...
o serviço por meio do newsletter do {{site.data.keyword.Bluemix_notm}} e dos canais de mídia social. Para obter mais informações, consulte [Criando seu anúncio de marketing](/docs/third-party?topic=third-party-announcement#announcement). | Ambiente de trabalho do provedor |
...
recurso. <br><br>  | Use o console de gerenciamento de recurso para criar uma oferta exclusiva. Para obter mais informações, consulte [as etapas para registrar sua oferta](/docs/third-party?topic=third-party-register#register). | Console de gerenciamento de recurso |
...
recurso exibido no quadro do {{site.data.keyword.Bluemix_notm}}. Para obter mais informações, consulte [as etapas para inserir os metadados da oferta](/docs/third-party?topic=third-party-offering-metadata#offering-metadata). | Console de gerenciamento de recurso |
...
hora automatizado.| Como você cobrará pelo serviço? O console de gerenciamento de recurso fornece planos grátis ou pagos. Para obter mais informações, consulte [as etapas para desenvolver um plano de precificação](/docs/third-party?topic=third-party-pricing-plan#pricing-plan). | Console de gerenciamento de recurso |
...
Broker. Para obter mais informações, consulte [as etapas para exportar seus metadados](/docs/third-party?topic=third-party-export-metadata#export-meta). | Console de gerenciamento de recurso |
...
que permitem que as instâncias de serviço sejam desativadas e reativadas. |  O Open Service Broker do {{site.data.keyword.Bluemix_notm}} estende a especificação do Open Service Broker 2.12. [Conheça](/docs/third-party?topic=third-party-docs#docs) os terminais necessários que o broker de serviço deve usar. | Documentação |
...
de gerenciamento de recurso, é possível usá-lo para informar o desenvolvimento do Open Service Broker. Para obter mais informações, consulte [as etapas para usar metadados exportados para guiar o desenvolvimento](/docs/third-party?topic=third-party-use-metadata#use-metadata). | Ambiente de desenvolvimento e documentação |
...
responder às chamadas da API de REST. E seu local hospedado deve atender às diretrizes de segurança do {{site.data.keyword.Bluemix_notm}}. Para obter mais informações, consulte [as etapas para hospedar seu broker de serviço](/docs/third-party?topic=third-party-host#host). | Ambiente de desenvolvimento e documentação |
...
os comandos curl com relação aos diferentes terminais que você está ativando. Para obter mais informações, consulte [as etapas para testar seu broker de serviço](/docs/third-party?topic=third-party-host#broker-test).| Ambiente de desenvolvimento e documentação |
...
os usuários estejam corretamente autorizados, assegurando que os usuários do serviço possam acessar o painel de serviço. Para obter mais informações, consulte [as etapas para validar](/docs/third-party?topic=third-party-validate#validate). | Ambiente de desenvolvimento e documentação |
...
especificação do Open Service Broker, é possível publicar o serviço no catálogo do {{site.data.keyword.Bluemix_notm}}. Para obter mais informações, consulte [as etapas para testar seu serviço](/docs/third-party?topic=third-party-test-your-service#test). | Console do {{site.data.keyword.Bluemix_notm}} |
