...
* Si un utilisateur est connecté, il est immédiatement redirigé. Le navigateur effectue un rappel pour rediriger l'URI afin de fournir un paramètre de réponse "code" et une valeur "state"
* Si un utilisateur n'est pas connecté, une invite de connexion s'affiche. Une fois l'utilisateur connecté, le navigateur effectue un rappel pour rediriger l'URI afin de fournir un paramètre de réponse "code" et une valeur "state". 
