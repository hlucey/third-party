...
#### Tägliche anteilmäßige Verrechnung (Maximalwert)
...
Sie können die Skalierungskonfiguration verwenden, um die Einheitenmenge anders als bei der Übermittlung von Nutzungsdaten, bei der Anzeige im Nutzungsdashboard und anders als die abschließend verwendeten Daten für die Bewertung und Kostenberechnungen zu kompilieren. In den folgenden Beispielen werden Szenarios dargestellt, in denen diese Werte konfiguriert werden sollten:
