...
{: caption="표 6. 일별 최대 사용량 및 월별 평균 계산" caption-side="top"}
...
| 단순 계층(세부 계층)  | 모든 이용에 대한 단가에서 P*Q 모델은 수량이 속한 계층에 의해 결정됩니다.           | <ul><li>If Q is <=Q1, T=P1*Q</li><li>If Q1 < Q <=Q2, T=P2*Q</li><li>If Q2 < Q <=Q3, T=P3*Q</li></ul>     |   <ul><li>Q1=1000, P1=$1</li><li>Q2=2500, P2=$0.9</li><li>Q3=10000, P3=$0.75</li><li>T=$0.75*5000=$3750</li></ul>              |
| 누진 계층(단계 계층)   | 단가는 이용하는 양이 사전 정의된 다른 계층으로 이동함에 따라 달라집니다. 총 요금에는 이전 계층의 요금이 누적됩니다.           | <ul><li>T1=P1*Q (0 < Q</li><li>If Q1 < Q <=Q2, T=T2</li><li>If Q2 < Q <=Q3, T=T3</li></ul>     | <ul><li>Q1=1000, P1=$1, T1=1*1000</li><li>Q2=1500, P2=$0.9, T2=0.9*1500</li><li>Q3=10000, P3=$0.75, T3=0.75*2500</li><li>T=1000 +1350+1875=$4225</li></ul>          |
| 블록 계층(최대)           | 요금이 부과되는 총 양은 블록 내에서 변하지 않는 "최대" 양으로 설정됩니다.     | <ul><li>If Q is <=Q1, T=T1</li><li>If Q1 < Q <=Q2, T=T2</li><li>If Q2 < Q <=Q3, T=T3</li></ul>    |  <ul><li>Q1=1000, T1=$0</li><li>Q2=2500, T2=2500</li><li>Q3=10000, T3=$4500</li><li>T=$4500</li></ul>            |
{: caption="표 7. 가격 모델" caption-side="top"}
